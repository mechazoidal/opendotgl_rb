...
class Geometry
  ...
  def initialize(window)
    ...
    @shaderProgram.load_and_attach(:fragment, File.open(frag_source, "r") {|f| f.read})
    ...
    points = [
      [-0.45,  0.45, 1.0, 0.0, 0.0, 4.0], # Red point
      [ 0.45,  0.45, 0.0, 1.0, 0.0, 8.0], # Green point
      [ 0.45, -0.45, 0.0, 0.0, 1.0, 16.0], # Blue point
      [-0.45, -0.45, 1.0, 1.0, 0.0, 32.0]] # Yellow point
    ...
    # Color is the latter three items
